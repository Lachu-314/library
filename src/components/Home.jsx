...
import backimages from './Images/backimages.jpg';
...
const Home = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:8080/viewbookAdmin')
      .then((response) => {
    ...
    <div>
      ...
      <div style={{ position: 'relative' }}>
        <Box sx={{ width: '100%', height: '80%' }}>
          <img src={library} alt='back' style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
        </Box>
